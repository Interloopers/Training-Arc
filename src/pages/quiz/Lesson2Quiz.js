...
const Lesson2Quiz = () => {
  const questions = [
    {
      ...
      options: ["Go", "Stop", "Yield", "Proceed with caution"],
      answer: 1
    },
    {
      question: "When should you prepare to stop at a traffic signal?",
      options: ["When the light is green", "When the light turns yellow", "When there are no cars", "When you are late"],
      answer: 1
    },
    {
      question: "What should you do at a green traffic light?",
      options: ["Stop and wait", "Go if the intersection is clear", "Speed through", "Yield to pedestrians"],
      answer: 1
    },
    {
      question: "What does a blinking yellow light mean?",
      options: ["Proceed with caution", "Stop immediately", "All traffic must yield", "Go quickly"],
      answer: 0
    },
    {
      question: "If you see a yellow traffic light, what should you do?",
      options: ["Speed up to pass before it turns red", "Prepare to stop", "Ignore the light", "Wait for it to turn green"],
      answer: 1
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-50 to-blue-100 flex flex-col items-center p-6">
      <h1 className="text-5xl font-bold text-blue-800 mt-10">Lesson 2 Quiz</h1>
