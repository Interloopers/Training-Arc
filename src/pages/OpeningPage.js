      ...
      <nav className="p-6 bg-gray-900 text-white fixed w-full z-10 shadow-lg">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <ul className="flex space-x-6 items-center">
            ...
            <li><a href="/about" className="hover:text-yellow-400 transition duration-200 text-lg">Rewards</a></li>
            <li><a href="/contact" className="hover:text-yellow-400 transition duration-200 text-lg">Quests</a></li>
